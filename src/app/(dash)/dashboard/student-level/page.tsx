...
const StudentLevelPage: FC = () => {
    const [schools, setSchools] = useState([]);

    useEffect(() => {
        fetch('https://edupy-server.vercel.app/get-all-student-levels')
          .then((res) => res.json())
          .then((data) => {
            setSchools(data)
          })
    ...
    const columns = [
        {
            header: "studyRoutine",
            accessorKey: "studyRoutine.value",
        },
        {
            header: "humanityLevel",
            accessorKey: "humanityLevel.value",
        },
        {
            header: "humanityLevel",
            accessorKey: "humanityLevel.value",
        ...
        {
            header: "liesCount",
            accessorKey: "liesCount.value",
        },
        {
            header: "ordersFollowed",
            accessorKey: "ordersFollowed.value",
        },
        {
            header: "treePlantation",
            accessorKey: "treePlantation.value",
        },
    ];
